  ...
  return (
    <section className="py-24 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mentors Section (moved below Development Team) */}
        <div className="mb-20">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 px-4 py-2 rounded-full text-sm font-semibold mb-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Our mentors provide strategic direction, real-world perspective,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mentors.map((mentor, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${mentor.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                ></div>
                ...
                <div className="relative">
                  <div className="relative mb-6">
                    ...
                    />
                    <div
                      className={`absolute -bottom-3 -right-3 w-10 h-10 bg-gradient-to-r ${mentor.color} rounded-full border-4 border-white shadow-lg flex items-center justify-center`}
                    >
                      <Star className="w-5 h-5 text-white" />
                    </div>
                  </div>
