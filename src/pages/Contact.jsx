  ...
  const offices = [
    {
      ...
      country: "India",
      address:
        "Knowledge Park 2, IILM University, Greater Noida, State - Uttar Pradesh",
  ...
  const faqs = [
    {
      ...
      answer:
        "Most institutions are up and running within 2-4 weeks, including data migration and team training.",
    },
    {
      question: "Do you offer custom integrations?",
      answer:
        "Yes, we have a robust API and can build custom integrations with your existing systems.",
    },
    {
      question: "What kind of support do you provide?",
      answer:
        "We offer 24/7 chat support, dedicated customer success managers, and comprehensive training programs.",
    },
    {
      question: "Is there a free trial available?",
      answer:
        "Yes, we offer a 30-day free trial with full access to all features and dedicated onboarding support.",
    },
  ];
          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              <a
                ...
                className={`group ${
                  method.bgColor
                } rounded-2xl p-6 text-center transition-all duration-500 hover:scale-105 hover:shadow-xl border border-white/50 ${
                  isVisible ? "animate-fade-in-up" : ""
                }`}
                style={{ animationDelay: `${index * 150}ms` }}
              >
                <div
                  className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${method.color} text-white mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  ...
                  build a comprehensive network from scratch, our team is here
                  to help.
                </p>
              </div>
