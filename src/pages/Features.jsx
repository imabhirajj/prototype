      ...
      features: [
        {
          ...
          description:
            "Scalable SaaS platform serving multiple institutions with custom branding",
          badge: "Scalable",
        },
        {
          icon: Database,
          ...
          description:
            "Reliable, secure, and globally distributed with 99.9% uptime SLA",
          badge: "Reliable",
        },
        {
          icon: BarChart3,
          ...
          description:
            "Real-time insights with AI-powered recommendations and forecasting",
          badge: "AI-Powered",
        },
      ],
    },
      ...
      features: [
        {
          ...
          description:
            "AI-driven targeted messaging across email, SMS, and push notifications",
          badge: "Smart",
        },
        {
          icon: MessageSquare,
          ...
          description:
            "End-to-end event lifecycle with RSVP tracking and virtual attendance",
          badge: "Complete",
        },
        {
          icon: Globe,
          ...
          description:
            "LinkedIn API integration for career updates and professional networking",
          badge: "Connected",
        },
      ],
    },
      ...
      features: [
        {
          ...
          description:
            "Machine learning-powered mentor-mentee pairing based on goals and expertise",
          badge: "AI-Driven",
        },
        {
          icon: BarChart3,
          ...
          description:
            "Goal setting, milestone tracking, and achievement recognition system",
        ...
        },
        {
          ...
          description:
            "Integrated video conferencing with session notes and follow-up automation",
          badge: "Seamless",
        },
      ],
    },
      ...
      features: [
        {
          ...
          description:
            "Secure multi-currency donation handling with recurring gift management",
          badge: "Secure",
        },
        {
          icon: BarChart3,
          ...
          description:
            "Donor journey insights, conversion tracking, and ROI optimization",
          badge: "Data-Driven",
        },
        {
          icon: Heart,
          ...
          description:
            "Automated receipt generation with compliance reporting across jurisdictions",
          badge: "Compliant",
        },
      ],
    },
      ...
      features: [
        {
          ...
          description:
            "Bi-directional sync with Salesforce, HubSpot, and custom CRM systems",
          badge: "Universal",
        },
        {
          icon: Map,
          ...
          description:
            "Location-based alumni networking with interactive mapping and events",
        ...
        },
        {
          ...
          title: "API Ecosystem",
          description:
            "RESTful APIs with webhooks for custom integrations and automation",
      ...
      features: [
        {
          ...
          description:
            "AES-256 encryption at rest and in transit with zero-trust architecture",
        ...
        },
        {
          ...
          description:
            "GDPR, CCPA, and SOC 2 Type II compliance with data residency options",
          badge: "Certified",
        },
        {
          icon: Database,
          ...
          description:
            "Automated backups with 4-hour RTO and point-in-time recovery",
          badge: "Bulletproof",
        },
      ],
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Build, manage, and grow your alumni network with our integrated
            ...
            return (
              ...
              >
                {activeCategory === index && (
                  <>
                    <div
                      className={`${category.bgColor} rounded-3xl p-8 mb-12 border border-white/50`}
                    >
                      <div className="flex items-center gap-4 mb-4">
                        <div
                          className={`p-4 rounded-2xl bg-gradient-to-r ${category.color} text-white`}
                        >
                            ...
                            <div className="flex items-start gap-4 mb-6">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <span
                                    className={`px-3 py-1 text-xs font-semibold rounded-full bg-gradient-to-r ${category.color} text-white`}
                                  >
                                    {feature.badge}
                                  </span>
                                </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join hundreds of institutions already leveraging our comprehensive
              platform
            </p>
                ...
                <div className="flex items-center justify-between p-8 border-b border-gray-200">
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">
                      Experience our comprehensive features in action
                    </p>
                  </div>
                  <button
