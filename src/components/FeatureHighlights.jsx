      ...
      features: [
        {
          ...
          desc: "Email, SMS, push notifications",
        },
        {
          icon: Target,
          title: "Event management",
          desc: "Seamless event creation and tracking",
        },
        {
          icon: Zap,
          title: "Newsletter automation",
          desc: "Smart content distribution",
        },
        {
          icon: MessageCircle,
          title: "Social media integration",
          desc: "LinkedIn and platform sync",
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          desc: "Intelligent mentor-mentee pairing",
        },
        {
          icon: Target,
          title: "Goal tracking",
          desc: "Progress monitoring and milestones",
        },
        {
          icon: MessageCircle,
          title: "Video conferencing",
          desc: "Built-in meeting platform",
        },
        {
          icon: Globe,
          title: "Progress analytics",
          desc: "Detailed relationship insights",
        },
      ],
    },
    {
      ...
      features: [
        {
          ...
          desc: "End-to-end campaign tools",
        },
        {
          icon: IndianRupee,
          title: "Donation processing",
          desc: "Secure payment handling",
        },
        {
          icon: Globe,
          title: "Donor analytics",
          desc: "Comprehensive donor insights",
        },
        {
          icon: Zap,
          title: "Tax documentation",
          desc: "Automated receipt generation",
        },
      ],
    },
  ];
    ...
    <section ref={ref} className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Comprehensive tools designed to strengthen alumni relationships and
            drive engagement.
          </motion.p>
        </motion.div>
            ...
            {highlights[activeTab].features.map((feature, index) => (
              ...
              >
                <div className="relative z-10">
                  ...
                  <motion.h3 className="text-lg font-bold text-gray-900 mb-2">
                    {feature.title}
                  </motion.h3>
