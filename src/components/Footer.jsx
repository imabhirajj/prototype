        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 items-start">
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-4">
              The modern alumni engagement platform for institutions that want
              real outcomes: stronger networks, higher participation, and
              measurable impact.
            </p>
            <div className="flex items-center gap-3">
              <a
                aria-label="Follow on Twitter"
                className="p-2 rounded-lg border border-gray-200 hover:border-blue-500 hover:text-blue-600 transition-colors"
                href="#"
              >
          ...
          <div className="grid grid-cols-2 gap-8 text-sm text-gray-600 lg:col-span-2">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a className="hover:text-blue-600" href="/why-alumni-nexus">
                    Why Us
                  </a>
                </li>
              </ul>
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Get product updates and best practices for alumni engagement.
            </p>
