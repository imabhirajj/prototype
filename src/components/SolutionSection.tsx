  ...
  const solutions = [
    {
      ...
      description: 'Unified alumni database with real-time synchronization across all touchpoints.',
    ...
    },
    {
      ...
      description: 'Intuitive communication tools that drive meaningful alumni interactions.',
    ...
    },
    {
      ...
      description: 'AI-powered matching system connecting alumni with students and peers.',
    ...
    },
    {
      ...
      description: 'Integrated payment processing with automated campaign management.',
    ...
    },
    {
      icon: Shield,
      title: 'Career Growth',
      description: 'Job board, networking events, and professional development resources.',
    ...
    },
    {
      icon: Sparkles,
      title: 'AI Analytics',
      description: 'Advanced insights and predictive analytics for better decision making.',
    ...
    <section ref={ref} className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Everything your institution needs to build and maintain thriving alumni relationships.
          </motion.p>
        </motion.div>
          ...
          {solutions.map((solution, index) => (
            ...
            >
              ...
              >
                ...
                {/* Sparkle Effects */}
                {hoveredCard === index && Array.from({ length: 6 }).map((_, i) => (
                  <motion.div
                    key={i}
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                >
                  <div className={`w-full h-full bg-gradient-to-br ${solution.color} rounded-bl-full`} />
                </motion.div>
              </motion.div>
            </motion.div>
          ))}
