    ...
    <section ref={ref} className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Most institutions struggle with fragmented alumni data and poor engagement rates.
          </motion.p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Alumni Nexus Solution</h3>
